...
public class Model {
    ...
    /*
     * if a certain player wins in that row returns that players number else returns
     * 0 input: the row you want to check
     */
    ...
    /*
     * if a certain player wins in that column returns that players number else
     * returns 0 input: the column you want to check
     */
    ...
    /*
     * if a certain player wins in the first diagonal (the one that starts top left)
     * returns that players number else returns 0 input: none
     */
    ...
    /*
     * if a certain player wins in the second diagonal (the one that starts bottom
     * left) returns that players number else returns 0 input: none
     */
